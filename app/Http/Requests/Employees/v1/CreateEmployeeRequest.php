...
namespace App\Http\Requests\Employees\v1;

use Core\Utils\Requests\CreateResourceRequest;
use Domains\Employees\DataTransfertObjects\CreateEmployeeDTO;
use Domains\Employees\People\DataTransfertObjects\CreatePersonDTO;
 ...
 */
class CreateEmployeeRequest extends CreateResourceRequest
{

    public function __construct(){
        parent::__construct(CreateEmployeeDTO::fromRequest(request()));
    }
