...
namespace Domains\Devises\DataTransfertObjects;
 ...
 *
 * @package ***`\Domains\Devises\DataTransfertObjects`***
 */
class CreateDeviseDTO extends BaseDTO
{
    ...
    {
        $rules = array_merge([
            "name"            		=> ["string", "required", 'unique:devise,name'],
            "symbol"            	=> ["string", "required", 'unique:devise,symbol'],
