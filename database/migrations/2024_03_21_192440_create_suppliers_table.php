 ...
 *
 * A migration class for creating the "Suppliers" table with UUID primary key and timestamps.
 *
 * @package ***`\Database\Migrations\CreateSuppliersTable`***
 */
class CreateSuppliersTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            Schema::create('suppliers', function (Blueprint $table) {
                // Define a UUID primary key for the 'suppliers' table
            ...
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to migrate "suppliers" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            // Handle the exception (e.g., logging, notification, etc.)
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to drop "suppliers" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
