 ...
 *
 * A migration class for creating the "clients" table with UUID primary key and timestamps.
 *
 * @package ***`\Database\Migrations\CreateCLientsTable`***
 */
class CreateCLientsTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            Schema::create('clients', function (Blueprint $table) {
                // Define a UUID primary key for the 'clients' table
            ...
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to migrate "clients" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            // Handle the exception (e.g., logging, notification, etc.)
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to drop "clients" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
